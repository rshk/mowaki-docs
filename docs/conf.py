...
latex_documents = [
    (master_doc, 'MoWAKi.tex', 'MoWAKi Documentation',
     'Samuele Santi', 'manual'),
]
...
man_pages = [
    (master_doc, 'mowaki', 'MoWAKi Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MoWAKi', 'MoWAKi Documentation',
     author, 'MoWAKi', 'One line description of project.',
     'Miscellaneous'),
]
